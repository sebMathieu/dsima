...
class QuantitativeCriteria(StateAgent):
    ...
    def initialize(self, data):
        ...
        data.personal[self.name]['protectionsCost']=[0.0]
        ...
        data.personal[self.name]['statusVariables'].extend(('welfare','dsosCosts','protectionsCost','tsosCosts','producersCosts','retailersCosts'))
    ...
    def act(self,data,layer):
        ...
        for u in self._users:
            ...
            if isinstance(u, DSO):
                ...
                data.personal[self.name]['protectionsCost'][0]+=data.personal[u.name]['protectionsCost']
        ...
        data.personal[self.name]['welfare'][0]-=data.personal[self.name]['protectionsCost'][0]
